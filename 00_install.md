...
<image src="images/Apple仮想化.png" alt="Apple仮想化" width="600">
...
<image src="images/仮想マシン作成.png" alt="仮想マシン作成" width="600">
...
4. ストレージ選択で VirtIO 仮想ディスクを指定

5. root パスワードやユーザーアカウントを作成

6. インストール開始 → 完了まで待機（数分〜十数分）

7. インストール完了後、仮想マシンを再起動

<image src="images/システムの再起動.png" alt="再起動" width="600">
